...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Meu portfolio &#8212; WordPress</title>
...
<meta name="msapplication-TileImage" content="./wp-content/uploads/2023/06/5937199.png">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="https://localhost/portfolio/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
									<input type="hidden" name="redirect_to" value="https://localhost/portfolio/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir para Meu portfolio</a>		</p>
			</div>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"419e40e392"};</script>
